<?php
	// General
	$moxieManagerConfig['general.license'] = 'UZRD-2CXD-2QD5-DDBL-7XL3-NMNJ-7K7U-LHXB';
	...
	$moxieManagerConfig['general.temp_dir'] = '/tmp';
	...
	$moxieManagerConfig['basicauthenticator.users'] = array(
		array("username" => "iain@boothsgardenstudios.co.uk", "password" => "1234", "groups" => array("administrator"))
	);
