    ...
    <div class="form-group table-responsive">
      ...
      <table id="postcode-submit" class="table table-bordered table-condensed table-pricing">    
        ...
        <tr>
          ...
          <td><input type="radio" name="size" id="6100x2440" value="6100x2440" <?php if(@$_POST['size'] == '6100x2440' ) : ?>checked<?php endif; ?>><label for="6100x2440">{{ $data->layouts['6100x2440']->formatted_cost }}</label></td>
        </tr>                            
      </table>
