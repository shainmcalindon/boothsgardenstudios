<form method="post" role="form">
  <fieldset>
    <div class="form-group">
      ...
      <input type="text" id="title" name="title" value="{{{ Input::old('title', $gallery->title) }}}" class="form-control">
    </div>
    <div class="form-group">
      <label class="control-label sr-only">Slug</label>
      <input id="slug" name="slug" placeholder="" class="form-control" type="text" value="{{{ Input::old('slug', $gallery->slug) }}}">
    ...
    <div class="form-group">
      ...
      <a id="remove" name="remove" class="btn btn-danger pull-right" href="/user/galleries/remove/{{{ $gallery->id }}}">Remove</a>
      @endif
    </div>
  </fieldset>
</form>
